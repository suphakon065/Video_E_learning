...
function EditQuizEditPage(props) {
  ...
  const [Quiz,setQuiz]=useState({
    ...
    StopTime: EditData.StopTime,
    coundown: EditData.coundown,
    NumQuest: EditData.NumQuest,
            ...
            <Paper elevation={3} sx={CreeateQuizpaperBodyStyles}>
              <Grid container spacing={3}>
                {question.map((element,i) =>{
                  console.log('319: ',element);
                  const datas = {
                    element,
                    i,
                  }
                  // console.log('help me plese.',EditData.Question[i].Ans)
                  return(
                    <>
                      ...
                      {question[datas.i].PIC === null?
                        ...
                        <Grid container style={{alignItems: 'center',marginBottom: 20}}>
                          ...
                          <Grid xs={6} align={'center'}>
                            <img 
                              src={question[datas.i].image?question[datas.i].image:Servicesconfig.getImageQuest+question[datas.i].PIC.toLowerCase()}
                              width='50%'
                              height='50%'
                            />
                          </Grid>
                      ...
                      <Grid item xs={0} lg={8} sx={CreeateQuizGridblankStyles}></Grid>
                          <Grid item xs={11} lg={4}>
                              <FormControl sx={CreeateQuizFormControllStyles} size='small' fullWidth>
                                  ...
                                  >
                                      <MenuItem value={true}>Multiple </MenuItem>
                                      <MenuItem value={false}>Short Answer</MenuItem>
                                  </Select>
                              </FormControl>
                          </Grid>
                      </Grid>
...
export default EditQuizEditPage;